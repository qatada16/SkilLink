...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchProposals = async () => {
      if (currentUser.accType === "Freelancer" || currentUser.accType === "freelancer") {
    ...
    const fetchClientJobs = async () => {
      if (currentUser.accType === "Client" || currentUser.accType === "client") {
        const res = await fetch(
    ...
    if (currentUser.accType === "Freelancer" || currentUser.accType === "freelancer") fetchProposals();
        ...
        {currentUser ? (
          <>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              {(currentUser.accType === "Freelancer" || currentUser.accType === "freelancer") && (
                <>
                  <div
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  {(currentUser.accType === "Client" || currentUser.accType === "client") ? "Spent" : "Earnings"}
                </h3>
